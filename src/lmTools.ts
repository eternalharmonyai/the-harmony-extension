...
// Thin shim: lmTools snapshots are labeled with the '-vscode' source suffix.
async function createRequiredPreActionSnapshot(root: string, relativePaths: string[], reason: string) {
    return createPreActionSnapshot(root, relativePaths, reason, 'vscode');
}
